...
public enum RateLimitErrorEnum {
    ...
    USER_NOT_FOUND("syj-rateLimit say: can not found user info,please check request.getUserPrincipal().getName()"),
    CUSTOM_NOT_FOUND(String.format("syj-rateLimit say: can not found custom info,please check request.getAttribute('%s')", CUSTOM));
